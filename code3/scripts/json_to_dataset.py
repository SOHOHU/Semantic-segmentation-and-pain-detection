...
if __name__ == '__main__':
    jpgs_path   = "D:\KC_Code\VOC2007\JPEGImages"
    pngs_path   = "D:\KC_Code\VOC2007\\TrainPain"
    # classes     = ["_background_","person", "car", "motorbike", "dustbin","chair","fire_hydrant","tricycle","bicycle","stone"]
    classes     = ["_background_","face"]
    
    count = os.listdir("D:\KC_Code\VOC2007\\TrainPain")
    for i in range(0, len(count)):
        path = os.path.join("D:\KC_Code\VOC2007\\TrainPain", count[i])
