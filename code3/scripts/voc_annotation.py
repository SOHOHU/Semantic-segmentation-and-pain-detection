...
if __name__ == "__main__":
    ...
    segfilepath     = os.path.join(VOCdevkit_path, 'D:/KC_Code/VOC2007/SegmentationClass')
    saveBasePath    = os.path.join(VOCdevkit_path, 'D:/KC_Code/VOC2007/ImageSets/Segmentation')
