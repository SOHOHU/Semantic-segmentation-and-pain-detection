...
if __name__ == '__main__':
    ...
    # classes     = ["_background_","ear", "eye", "mouth", "nose", "iris", "saliva"]
    classes     = ["_background_","face", "ear", "eye", "mouth", "nose", "iris", "saliva"]
    ...
    for i in range(0, len(count)):
        ...
        if os.path.isfile(path) and path.endswith('json'):
            ...
            # except:
                # print("Error processing " + count[i].split(".")[0] + '.jpg and ' + count[i].split(".")[0] + '.png', '出错出错出错')
            except Exception as e:
                print(f"Error processing {count[i].split('.')[0]}: {str(e)}")
